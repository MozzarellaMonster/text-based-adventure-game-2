...
void the_glowing_cave_text()
{
    ...
    cout << "Bracing yourself, you close your eyes and take a step into the portal.\n"
            ...
            "You accidentally step into a deep puddle and end up making a large splash sound that echoes a bit within the confines of the cave.\n"
            ...
            "After the bat settles down, you quietly sigh in relief and carefully remove your soaked foot from the puddle.\n"
            "Looking back toward the ground level of the cave, you see two tunnels branching off from the chamber you're in directly ahead of you.\n"
            "There is also another path on the opposite side of the cave, between some large mushrooms you see a well-tread path leading further into the cave.\n\n";
        ...
        case 'c':
            ...
            else
            {
                cout << "You decide to explore the well-tread path on the opposite side of the cavern.\n"
                        ...
                        "A small smile plays across your lips as you confidently walk down the path that so many others have tread upon before you. Following in the footsteps of the Worldwalkers.\n";
                gc_pathway_text();
            }
            break;
...
void gc_left_tunnel_text()
{
    ...
    cout << "You find yourself in a large cavern, a narrow, natural land bridge stretching across a massive canyon splitting the chamber in two. A large waterfall cascades down from above and to the left of the land bridge,\n"
            ...
            "You look back up across the bridge and spy a flickering orange light in the distance. Squinting, you think you see shadows move back and forth in front of the light. A campfire, perhaps? If that's a campfire, then the\n"
    ...
    switch(choice)
    {
        case 'a':
            cout << "You decide to try and cross the bridge.\n"
                    ...
                    "as you make your dangerous trek forwards. Spreading your arms out and keeping your legs steady, you slowly make your way across the bridge, keeping your eyes firmly rooted to the path in front of you and\n"
                    "trying to avoid looking at the pitch black abyss below you at all costs. Step by cautious step, you make your way across the bridge. Puddles glint in the faint light of the moss and shine like stars as they\n"
                    "reflect the spray of the waterfall to the left of you. Finally, you're about halfway across the bridge and getting comfortable in your stride when your shoe gives way, surrendering to the slippery stone.\n"
        ...
        case 'b':
            if(!attention_seeker)
            {
                cout << "You decide to try and get the attention of the figures on the other side of the chasm. You look around for something to signal them with. All there really seems to be are some smooth pebbles and\n"
                        ...
                        "Specifically, it hits the light dead-on. You watch in stunned bewilderment as the stone bounces off the surface of something slightly translucent, behind which the glow emanates. Then, the \"campfire\" moves.\n"
                        ...
                        "which appears to be a fleshy bulb of some kind. You stare at the strange, flickering glow and feel a unusual urge to get even closer. You take a small step forward before realizing how close you are to the edge of the chasm\n"
                        ...
                        "the slingshot falling into the abyss. All the while, you're still staring at the monstrous face and when it hears you scuffle against the floor of the tunnel, it leaps forward with its mouth agape.\n"
                        "You scream, turn around and run back through the tunnel.\n";
...
void gc_right_tunnel()
{
    ...
    if(!gc_explored_right_tunnel)
    {
        cout << "You go through the dry tunnel. The air flowing past your body as you head further in.\n"
                ...
                "Unfortunately, most of the altar was smashed by the avalanche that blocked off the entrance.\n"
                ...
                "As if you heard a starting pistol, you take off in a mad sprint toward the tunnel. Immediately, the bats take to the air in a mammalian cyclone, screeching and diving towards you.\n"
                ...
                "You make it to the tunnel and run through, an angry bat trying to claw its way in, but can't due to its large size.\n"
...
void gc_pathway_text()
{
    ...
    cout << "You follow the trail for some distance before arriving in a small clearing in the forest of fungi. A portion of the dirt here is tilled and small, dead sprouts of an unknown plant line the ground.\n"
            ...
            "The feel of the blanket is so comforting, you wish you could take it with you. Unfortunately, you don't have anywhere to store it, so you leave it be. You take a step back and examine the cart as a whole.\n"
            "From what you can make of the damage, it appears the wheel had broken off of the axle and been left alongside the cart. You look back over the scene before you.\n"
            "It appears that whoever had left this cart here had been meaning to return for it. Given the nature of the objects and the state of the cart, they definitely had been meaning to return, but never did. Why?\n"
...
void gc_pathway(bool show_interlude=false)
{
    ...
    switch(choice)
    {
        ...
        case 'c':
            ...
            {
                cout << "You decide to explore the clearing more. You walk along the perimeter of the clearing until you come across a large mushroom with a small mound of out-of-place soil beneath it.\n"
                        ...
                        "After making your way halfway through the mound, your hands clasp around a solid weight. Pulling it out, you find that you're holding a small wooden box of unknown origin.\n"
